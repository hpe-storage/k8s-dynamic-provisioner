...
func TestDockerOptions(t *testing.T) {
	...
	outputOption, _ := p.parseStorageClassParams(getStorageClassParams(), getTestStorageClass(), invalidOption.claimSize, invalidOption.listOfStorageResourceOptions, "default")
	...
	outputOption, _ = p.parseStorageClassParams(getStorageClassParams(), getTestStorageClass(), validOption.claimSize, validOption.listOfStorageResourceOptions, "default")
	if outputOption["size"] == getStorageClassParams()["size"] {
...
func TestOverrides(t *testing.T) {
	...
	overrides := p.getClassOverrideOptions(params)
